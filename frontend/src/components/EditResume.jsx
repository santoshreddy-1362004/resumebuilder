...
const EditResume = () => {
  ...
  //update the state of resume data
  ...
  //fetch resume details by id
   ...
   //upload resume images it will help in choosing preview as well as helps in downloading the resume and saves resume as a image 
  ...
  // this functions will help in updating resume details and put will help in updation on backend
